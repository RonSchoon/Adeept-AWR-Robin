...
class RobotLight(threading.Thread):
	...
	def spinning(self):
		for j in range(1,10):
		  self.setSomeColor(255,255,255,[0])
		  for i in range(1,self.LED_COUNT):
		    self.setSomeColor(255,255,255,[i])
		    self.setSomeColor(0,0,0,[i-1])
		    time.sleep(0.1)
		  self.setSomeColor(0,0,0,[self.LED_COUNT-1])

	def rainbow(self):
		for j in range(1,self.LED_COUNT):
			for i in range(1,255):
				self.setSomeColor(255,i,0,[j % 6])
				self.setSomeColor(255-i,255,0,[(j+1) % 6])
				self.setSomeColor(0,255,i,[(j+2) % 6])
				self.setSomeColor(0,255-i,255,[(j+3) % 6])
				self.setSomeColor(i,0,255,[(j+4) % 6])
				self.setSomeColor(255,0,255-i,[(j+5) % 6])
				time.sleep(0.001)
